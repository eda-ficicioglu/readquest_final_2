...
class Config:
    ...
    READER_TYPE_GENRES = {
        ...
        "melancholic ruminator": ["classics", "drama", "contemporary", "poetry"],
    ...
    READER_TYPE_DESCRIPTIONS = {
        ...
        "melancholic ruminator": "You're introspective, a quiet observer of life’s bittersweet complexities. You love characters who reflect, break, rebuild — and sometimes just... feel.",
